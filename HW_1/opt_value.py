...
class OPTRouting(BASE_routing):
    ...
    def print(self):
        ...
        print("Exploration  -> ", OPTRouting.exploration)
        print("Exploitation -> ", OPTRouting.exploitation)
