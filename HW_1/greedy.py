...
class AIRouting(BASE_routing):
    ...
    def print(self):
        ...
        print("Exploration  -> ", AIRouting.exploration)
        print("Exploitation -> ", AIRouting.exploitation)
