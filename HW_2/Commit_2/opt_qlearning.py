...
# Optimistic q_learning with 2 actions

class OPTQRouting(BASE_routing):
    keep_pkt = 0
    send_pkt = 0
    move_to_depot = 0
    ...
    def print(self):
        ...
        print("Send the Packet: ", OPTQRouting.send_pkt)
        print("Keep the Packet: ", OPTQRouting.keep_pkt)
        print("Move to Depot: ", OPTQRouting.move_to_depot)
        print("####################################\n")
